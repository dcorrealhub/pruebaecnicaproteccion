...
public interface SaldoJpaRepository extends JpaRepository<Saldo, Long> {
    ...
    /**
     * Bloquea la fila del saldo del afiliado durante la transacción activa,
     * evitando que dos registros de aporte concurrentes lean el mismo
     * acumulado y sobrescriban su actualización (lost update).
     */
